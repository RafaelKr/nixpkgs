...
- The Traefik module has been refactored to allow new ways to deploy the dynamic and static configuration files, as well as nixpkgs packaged plugins. See [Migrating traefik for pre 26.11 configurations](#module-services-traefik-migrating-to-26.11).
